#!/usr/bin/env bash
# End-to-end deployment smoke test using bundled Neo-Express (neoxp).
#
...
"$NEO_SOLC_BIN" "$WORK_DIR/Smoke.sol" -o Smoke >/dev/null
...
# Invoke `height()` (native call via System.Contract.Call) and confirm it returns an Integer.
...
echo "✅ neoxp deploy smoke test passed"
