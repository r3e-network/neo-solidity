...
fn syscalls_contract_exists_uses_contract_management_is_contract() {
    ...
    let cm_hash_le =
        super::bytecode::native_contract_hash(neo_solidity::ir::NativeContract::ContractManagement);
...
fn mapping_storage_requires_crypto_keccak_and_stdlib_serialize_permissions() {
    ...
    let crypto_hash_le =
        super::bytecode::native_contract_hash(neo_solidity::ir::NativeContract::CryptoLib);
