...
const NATIVE_CONTRACTS: [NativeContractDescriptor; 11] = [
    ...
    NativeContractDescriptor {
        hash: [
            0xcf, 0x76, 0xe2, 0x8b, 0xd0, 0x06, 0x2c, 0x4a, 0x47, 0x8e, 0xe3, 0x55, 0x61,
            0x01, 0x13, 0x19, 0xf3, 0xcf, 0xa4, 0xd2,
        ],
        name: "GasToken",
    },
    NativeContractDescriptor {
    ...
    NativeContractDescriptor {
        hash: [
            0x3b, 0xec, 0x35, 0x31, 0x11, 0x9b, 0xba, 0xd7, 0x6d, 0xd0, 0x44, 0x92, 0x0b,
            0x0d, 0xe6, 0xc3, 0x19, 0x4f, 0xe1, 0xc1,
        ],
        name: "Notary",
    },
    NativeContractDescriptor {
        hash: [
            0xc1, 0x3a, 0x56, 0xc9, 0x83, 0x53, 0xa7, 0xea, 0x6a, 0x32, 0x4d, 0x9a, 0x83,
            0x5d, 0x1b, 0x5b, 0xf2, 0x26, 0x63, 0x15,
        ],
        name: "Treasury",
    },
    NativeContractDescriptor {
...
fn try_lower_nativecalls_member_builtin(
    ...
    match member.name.as_str() {
        ...
        "estimateNativeCallGas" => {
            ...
            instructions.push(Instruction::BinaryOp(BinaryOperator::Eq));
            instructions.push(Instruction::JumpIf { target: neo_skip_label });
            ...
            instructions.push(Instruction::BinaryOp(BinaryOperator::Eq));
            instructions.push(Instruction::JumpIf { target: cm_skip_label });
            ...
            instructions.push(Instruction::BinaryOp(BinaryOperator::Eq));
            instructions.push(Instruction::JumpIf { target: cm_update_label });
            instructions.push(Instruction::PushLiteral(LiteralValue::Integer(
        ...
        "batchNativeCalls" => {
            ...
            instructions.push(Instruction::Jump { target: length_ok_label });
