...
impl Lexer {
    ...
    fn read_string(&mut self) -> Result<Token, CompilerError> {
        ...
        if self.position >= self.input.len() {
            return Err(CompilerError::ParseError("Unterminated string literal".to_string()));
        }
    ...
    fn read_identifier(&mut self) -> Token {
        ...
        let token_type = match value.as_str() {
            ...
            "gas" | "gasprice" | "gaslimit" | "origin" | "address" | "balance" |
            "selfbalance" | "basefee" | "chainid" | "timestamp" | "number" | "difficulty" |
            "blockhash" | "coinbase" | "log0" | "log1" | "log2" | "log3" | "log4" |
            "create" | "create2" | "call" | "callcode" | "delegatecall" | "staticcall" |
            "return" | "revert" | "selfdestruct" => TokenType::BuiltinFunction,
