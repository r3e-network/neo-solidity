---
title: Use Cases
description: Learn what you can build with Neo DevPack for Solidity on the Neo N3 blockchain.
---
...
<div class="action-cta-box" style="margin-top: 2rem; padding: 2rem 1.5rem; text-align: left;">
  ...
  <a href="/basics/introduction-to-smart-contracts" class="cta-button">Read the docs</a>
</div>
...
[Learn more about Neo Standards in Devpack](/additional-material/neo-standards)
...
[Learn more about NeoVM Native Contracts](/internals/native-contracts)
...
[Learn about Syscalls](/internals/syscalls)
...
[**Explore the Code Examples**](/basics/quickstart)
