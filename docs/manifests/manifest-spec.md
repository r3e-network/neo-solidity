...
- [Native Contracts](/neovm/native-contracts) — Deterministic hashes and devpack wrappers for NEO, GAS, StdLib, CryptoLib, and other native contracts.
- [Syscalls](/neovm/syscalls) — NeoVM syscall reference and how the compiler maps Solidity constructs to syscall sequences.
- [Devpack Standards](/devpack/standards) — NEP-17, NEP-11, and other standard interface definitions in the devpack.
