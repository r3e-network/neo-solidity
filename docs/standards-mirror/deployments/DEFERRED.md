...
>
> The mirror catalog now exposes **79 ERC/EIP mapping pages**. The TestNet matrix
> covers **47 deployable standards**. The thirty-two catalog entries without a
...
> ERC-7144 (per-deployment validator shape).
>
