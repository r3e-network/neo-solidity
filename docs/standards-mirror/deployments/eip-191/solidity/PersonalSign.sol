...
/// @title PersonalSign — EIP-191 personal_sign / ecrecover demo, compiled to Neo N3.
...
/// CryptoLib.VerifyWithECDsa (secp256r1). This contract stores a registered signer
/// and a digest. The actual signature check happens in the C# port via VerifyWithECDsa.
