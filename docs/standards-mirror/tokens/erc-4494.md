...
ERC-4494 brings [ERC-2612](/standards-mirror/account-and-auth/erc-2612)-style gasless approvals to NFTs. The owner signs an [EIP-712](/standards-mirror/account-and-auth/eip-712)
...
Just like [ERC-2612](/standards-mirror/account-and-auth/erc-2612), the Ethereum signature-parsing mechanism is unnecessary on Neo. The user signs a
single transaction with `WitnessScope.CustomContracts` allowing the marketplace
contract to call `Transfer` on the NFT. No [EIP-712](/standards-mirror/account-and-auth/eip-712) domain separator or signature
...
Source pairs: [`docs/standards-mirror/deployments/erc-4494/`](https://github.com/r3e-network/neo-devpack-solidity/tree/main/docs/standards-mirror/deployments/erc-4494).
:::
