...
Source pairs: [`docs/standards-mirror/deployments/erc-2309/`](https://github.com/r3e-network/neo-devpack-solidity/tree/main/docs/standards-mirror/deployments/erc-2309).
:::
