...
[ERC-4337](/standards-mirror/account-and-auth/erc-4337)). Modules plug into accounts to add features: validators (validate user
...
Source pairs: [`docs/standards-mirror/deployments/erc-7579/`](https://github.com/r3e-network/neo-devpack-solidity/tree/main/docs/standards-mirror/deployments/erc-7579).
:::
