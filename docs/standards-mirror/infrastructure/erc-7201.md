...
Source pairs: [`docs/standards-mirror/deployments/erc-7201/`](https://github.com/r3e-network/neo-devpack-solidity/tree/main/docs/standards-mirror/deployments/erc-7201).
:::
