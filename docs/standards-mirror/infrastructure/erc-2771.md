...
Source pairs: [`docs/standards-mirror/deployments/erc-2771/`](https://github.com/r3e-network/neo-devpack-solidity/tree/main/docs/standards-mirror/deployments/erc-2771).
:::
