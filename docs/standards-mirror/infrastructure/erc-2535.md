...
ERC-2535 ("Diamonds") extends [ERC-1967](./erc-1967) to allow a single proxy to dispatch calls
...
Source pairs: [`docs/standards-mirror/deployments/erc-2535/`](https://github.com/r3e-network/neo-devpack-solidity/tree/main/docs/standards-mirror/deployments/erc-2535).
:::
