...
extends [ERC-20](/standards-mirror/tokens/erc-20) with per-batch expiry tracking — each mint creates a "lot" whose
...
Source pairs: [`docs/standards-mirror/deployments/erc-7818/`](https://github.com/r3e-network/neo-devpack-solidity/tree/main/docs/standards-mirror/deployments/erc-7818).
:::
