...
Source pairs: [`docs/standards-mirror/deployments/erc-3156/`](https://github.com/r3e-network/neo-devpack-solidity/tree/main/docs/standards-mirror/deployments/erc-3156).
:::
