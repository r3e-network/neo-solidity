...
[ERC-173](./erc-173). Where ERC-173 lets the current owner unilaterally
...
exposes so any ERC-173-aware tool can recognise governance-mediated
...
The pattern: a single **governance contract** holds the ERC-173 owner
