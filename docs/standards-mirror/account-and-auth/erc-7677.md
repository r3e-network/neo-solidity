...
This is the missing piece between the on-chain [ERC-4337](./erc-4337) paymaster
...
Ethereum's [ERC-4337](./erc-4337) separates "the user's signature" from "the
...
- **[ERC-2771](/standards-mirror/infrastructure/erc-2771)** — trusted forwarder. Neo's
...
The on-chain side stays the same as a vanilla [ERC-4337](./erc-4337) paymaster.
