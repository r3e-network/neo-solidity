...
2. Then validate via [ERC-1271](./erc-1271)'s `isValidSignature`.
...
[`docs/standards-mirror/deployments/erc-6492/`](https://github.com/r3e-network/neo-devpack-solidity/tree/main/docs/standards-mirror/deployments/erc-6492).
:::
