...
A meta-standard: contracts that use [EIP-712](./eip-712) should expose their domain via a single
...
Source pairs: [`docs/standards-mirror/deployments/erc-5267/`](https://github.com/r3e-network/neo-devpack-solidity/tree/main/docs/standards-mirror/deployments/erc-5267).
:::
