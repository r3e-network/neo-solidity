...
## Neo Solidity Influences

The `neo-solidity` compiler leverages this massive linguistic legacy to bring the largest smart contract developer base into the Neo ecosystem. 
...
Neo Solidity acts as a bridge between these two worlds:
