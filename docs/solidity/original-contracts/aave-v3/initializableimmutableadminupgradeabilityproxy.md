...
- Primary issue: function '_delegate': inline assembly is not supported help: Neo N3 uses NeoVM opcodes; use NativeCalls.sol for low-level operations
...
| --- | --- | --- |
| error | IR_GENERATION_ERROR | function '_delegate': inline assembly is not supported
