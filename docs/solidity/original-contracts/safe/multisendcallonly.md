...
- Primary issue: function 'multiSend': inline assembly is not supported help: Neo N3 uses NeoVM opcodes; use NativeCalls.sol for low-level operations
...
| --- | --- | --- |
| error | IR_GENERATION_ERROR | function 'multiSend': inline assembly is not supported
