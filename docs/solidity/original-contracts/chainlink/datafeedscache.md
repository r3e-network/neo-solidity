...
| error | IR_GENERATION_ERROR | function 'forceApprove': abi.encodeCall has an unsupported function reference |
| error | IR_GENERATION_ERROR | function '_callOptionalReturnBool': unsupported low-level EVM call 'call'
  help: Neo N3 does not support low-level EVM calls; use NativeCalls.sol for contract-to-contract interactions |
