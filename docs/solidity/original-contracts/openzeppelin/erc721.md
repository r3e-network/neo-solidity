...
- Status: ✅ pass
- Source type: `npm`
- Source path: `/Users/jinghuiliao/git/neo-solidity/third_party/famous-contracts/sources/@openzeppelin/contracts/token/ERC721/ERC721.sol`
...
Total diagnostics captured: `580`
...
| Code | Count | Example |
| --- | ---: | --- |
| W200 | 544 | function 'checkOnERC721Received' in 'ERC165' overrides 'Context::checkOnERC721Received' which is not marked 'virtual' |
| W121 | 28 | duplicate constant state variable 'GENERIC' detected while merging libraries |
...
- Upstream contract path: `/Users/jinghuiliao/git/neo-solidity/third_party/famous-contracts/sources/@openzeppelin/contracts/token/ERC721/ERC721.sol`