...
- Primary issue: inheritance linearization failed for 'VestingWallet': inconsistent base order
...
| --- | --- | --- |
| error | GENERIC_ERROR | inheritance linearization failed for 'VestingWallet': inconsistent base order |
