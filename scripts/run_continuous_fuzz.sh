...
while true; do
  ...
  COV1=$(grep "^#.*cov:" /tmp/fuzz-continuous/cargofuzz1-$ROUND.log | tail -1 | awk '{print $3}' || true)
  ...
  COV2=$(grep "^#.*cov:" /tmp/fuzz-continuous/cargofuzz2-$ROUND.log | tail -1 | awk '{print $3}' || true)
